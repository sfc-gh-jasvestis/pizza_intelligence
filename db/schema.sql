...
INSERT INTO MENU_ITEMS (item_id, name, category, price, prep_time_min) VALUES
    ('PIZ001', 'Pepperoni Classic', 'pizza', 18.99, 12),
    ('PIZ002', 'Margherita', 'pizza', 16.99, 10),
    ('PIZ003', 'BBQ Chicken', 'pizza', 21.99, 14),
    ('PIZ004', 'Veggie Supreme', 'pizza', 19.99, 12),
    ('PIZ005', 'Meat Lovers', 'pizza', 23.99, 15),
    ('PIZ006', 'Hawaiian', 'pizza', 17.99, 11),
    ('PIZ007', 'Buffalo Chicken', 'pizza', 20.99, 13),
    ('PIZ008', 'Four Cheese', 'pizza', 18.99, 11),
    ('SID001', 'Garlic Bread', 'sides', 5.99, 5),
    ('SID002', 'Caesar Salad', 'sides', 8.99, 3),
    ('SID003', 'Chicken Wings (8pc)', 'sides', 12.99, 10),
    ('DRK001', 'Coca-Cola', 'drinks', 2.99, 0),
    ('DRK002', 'Sprite', 'drinks', 2.99, 0),
    ('DRK003', 'Iced Tea', 'drinks', 2.99, 0),
    ('DES001', 'Chocolate Brownie', 'dessert', 6.99, 2),
    ('DES002', 'Tiramisu', 'dessert', 7.99, 2);
