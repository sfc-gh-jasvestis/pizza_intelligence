...
streamlit run "$SCRIPT_DIR/pizza_ops_assistant.py" --server.port 8502 --server.headless true &
streamlit run "$SCRIPT_DIR/driver_app.py" --server.port 8503 --server.headless true &
streamlit run "$SCRIPT_DIR/customer_app.py" --server.port 8504 --server.headless true &

sleep 3

echo "============================================"
echo "Apps Running:"
echo "  Ops Dashboard:  http://localhost:8502"
echo "  Driver App:     http://localhost:8503"
echo "  Customer App:   http://localhost:8504"
echo "============================================"
echo ""
